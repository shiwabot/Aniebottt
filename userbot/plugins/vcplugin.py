...
from userbot.helpers.queues.queues import (
    QUEUE,
    add_to_queue,
    clear_queue,
    get_queue,
...
@bot.on(admin_cmd(outgoing=True, pattern=r"play(?:\s|$)([\s\S]*)"))
...
@bot.on(admin_cmd(outgoing=True, pattern=r"vplay(?:\s|$)([\s\S]*)"))
...
@bot.on(admin_cmd(outgoing=True, pattern="end$"))
...
@bot.on(admin_cmd(outgoing=True, pattern=r"skip(?:\s|$)([\s\S]*)"))
...
@bot.on(admin_cmd(outgoing=True, pattern="pause$"))
...
@bot.on(admin_cmd(outgoing=True, pattern="resume$"))
...
@bot.on(admin_cmd(outgoing=True, pattern=r"volume(?: |$)(.*)"))
...
@bot.on(admin_cmd(outgoing=True, pattern="playlist$"))
