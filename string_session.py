...
print("""\n\nWelcome To Anie String Session\nGenerator By @d3nvil \n\n""")
...
while True:
    try:
        with TelegramClient(StringSession(), API_KEY, API_HASH) as client:
            ...
            client.send_message(
                "me",
                f"Here is your TELEGRAM STRING SESSION\n(Tap to copy it)👇 \n\n `{session}` \n\n And Visit @Aniebotsupports For Any Help!\n\n",
            )

            print(
                "Thanks for Choosing Anie Have A Good Time....Note That When You Terminate the Old Session ComeBack And Genrate A New String Session Old One Wont Work"
            )
    except:
        print("")
        print(
